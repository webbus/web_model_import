...
/**
 * Test case for class Tx_WebModelImport_Domain_Model_Address.
 *
 * @version $Id$
 ...
 *
 */
class Tx_WebModelImport_Domain_Model_AddressTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_WebModelImport_Domain_Model_Address
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_WebModelImport_Domain_Model_Address();
	}
